export const COMMON_WORDS = [
  ...
  "head", "under", "story", "saw", "left", "dont", "few", "while", "along", "might",
  "close", "something", "seem", "next", "hard", "open", "example", "begin", "life", "always",
];

const QUOTES = [
  "The quick brown fox jumps over the lazy dog while the sun slowly sets behind the distant mountains, painting the sky in brilliant shades of orange and pink.",
  "Success is not final, failure is not fatal: it is the courage to continue that counts. Every great achievement was once considered impossible until someone believed it could be done.",
  "In the middle of difficulty lies opportunity. The only way to do great work is to love what you do, and if you have not found it yet, keep looking and never settle.",
];
